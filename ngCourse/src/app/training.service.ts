...
export class TrainingService {
  ...
  public addCourse(matrial:Matrial):Observable<any>{
    return this._http.post<any>("http://localhost:8080/addmatrial",matrial,{responseType:'text' as 'json'});
  }

  public deleteMatrial(course){
    return this._http.delete<any>("http://localhost:8080/deletematrial/"+course);
  }
